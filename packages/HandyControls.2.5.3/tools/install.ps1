...
#			[System.Windows.MessageBox]::Show("No application node found", 'TEST', 'OK')
		...
		$resourcesElementSkin = $appXamlXml.CreateNode("element", "hc:Theme", "https://handyorg.github.io/handycontrol")
		$resourcesElementSkin.SetAttribute("Name", $null, "HandyTheme")
